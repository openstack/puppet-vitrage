...
describe 'vitrage::keystone::authtoken' do
  ...
  shared_examples 'vitrage::keystone::authtoken' do

    context 'with default parameters' do

      it 'configure keystone_authtoken' do
        is_expected.to contain_keystone__resource__authtoken('vitrage_config').with(
          :username                       => 'vitrage',
          :password                       => 'vitrage_password',
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_configures 'vitrage::keystone::authtoken'
    end
  end
