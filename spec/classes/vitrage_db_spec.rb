...
describe 'vitrage::db' do
  ...
  shared_examples 'vitrage::db' do
    context 'with default parameters' do
      ...
      it { is_expected.to contain_vitrage_config('database/max_overflow').with_value('<SERVICE DEFAULT>') }
    end
    ...
    context 'with specific parameters' do
      ...
      it { is_expected.to contain_vitrage_config('database/max_overflow').with_value('21') }
    end
