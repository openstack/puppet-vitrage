...
describe 'vitrage' do
  ...
  shared_examples 'vitrage' do
    ...
    context 'with rabbit ssl enabled with kombu' do
      ...
      it 'configures rabbit' do
        is_expected.to contain_vitrage_config('oslo_messaging_rabbit/rabbit_use_ssl').with_value(true)
        is_expected.to contain_vitrage_config('oslo_messaging_rabbit/kombu_ssl_ca_certs').with_value('/etc/ca.cert')
        is_expected.to contain_vitrage_config('oslo_messaging_rabbit/kombu_ssl_certfile').with_value('/etc/certfile')
        is_expected.to contain_vitrage_config('oslo_messaging_rabbit/kombu_ssl_keyfile').with_value('/etc/key')
        is_expected.to contain_vitrage_config('oslo_messaging_rabbit/kombu_ssl_version').with_value('TLSv1')
      end
    end
    ...
    context 'with rabbit ssl enabled without kombu' do
      ...
      it 'configures rabbit' do
        is_expected.to contain_vitrage_config('oslo_messaging_rabbit/rabbit_use_ssl').with_value(true)
        is_expected.to contain_vitrage_config('oslo_messaging_rabbit/kombu_ssl_ca_certs').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_vitrage_config('oslo_messaging_rabbit/kombu_ssl_certfile').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_vitrage_config('oslo_messaging_rabbit/kombu_ssl_keyfile').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_vitrage_config('oslo_messaging_rabbit/kombu_ssl_version').with_value('<SERVICE DEFAULT>')
      end
    end
